...
def read_scoring_matrix(sm_file):
    ...
    try:
        ...
        return np.identity(20) # IP updated to numpy version
...
idr_background_distr = [0.077, 0.061, 0.032, 0.048, 0.014, 0.053, 0.083, 0.075, 0.024, 0.025, 0.075, 0.059, 0.018, 0.020, 0.098, 0.118, 0.058, 0.006, 0.014, 0.044]
...
bg_distribution = idr_background_distr[:]
...
for opt, arg in opts:
    ...
    if opt == "-o":
        ...
        elif arg == 'vn_entropy': scoring_function = vn_entropy;import numpy.linalg as la
...
try:
    if outfile_name != "":
        ...
        # IP 5/12 -- commented out this print outs
