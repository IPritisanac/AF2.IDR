1. Supp Figure 9A ==> distribution of pLDDT scores of CheZOD and Anchor flexible linkers database
   Supp Figure 9D ==> ROC curve of MFIB as positive dataset and either Chezod or Anchor flexible linkers as negative dataset
...
2. For the distribution plot in Supp Figure 9A:
...
3. For the ROC plot in Supp Figure 9D:
